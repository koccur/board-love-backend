...
export class InitialSchema1740075778084 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "spot" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "description" character varying, "locationLat" character varying NOT NULL,"locationLng" character varying NOT NULL, "openDays" character varying, "openHour" integer, "closeHour" integer, CONSTRAINT "PK_f2a0a47e5ae78713daf83a5f7b0" PRIMARY KEY ("id"))`);
